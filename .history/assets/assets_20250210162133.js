...
export const workData = [
    ...
    },
    {
        ...
        description: 'BookIt is a meeting room booking system built with Next.js, Appwrite, and Tailwind CSS. Users can list, edit, and manage rooms with features like built-in authentication, Appwrite database, real-time availability tracking, and booking validation to prevent double booking.',
        bgImage: '/bookit.png',
